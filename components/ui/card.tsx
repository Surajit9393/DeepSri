      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-12">
          {services.map((service, index) => (
            ...
            >
              <div className="bg-white rounded-xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300 h-full group relative border-4 border-transparent hover:border-blue-500 overflow-hidden">
                {/* Flashing Gradient Border */}
                <div className="absolute inset-0 bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 opacity-20 animate-border"></div>
                <div className="flex items-center justify-center mb-6">
                  <service.Icon className="w-16 h-16 text-blue-600" />
                </div>
                <h3 className="text-xl font-bold text-transparent bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 bg-clip-text mb-4 text-center">
                  {service.title}
                </h3>
